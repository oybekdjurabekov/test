                    ...
                    <div class="col-lg-8 col-md-12 col-sm-12 col-xs-12">
                        <div class="page-wrapper">
                            <div class="blog-title-area">
                                ...
                                <span class="color-yellow"><a href="#" title="">{{items.category}}</a></span>

                                <h3>{{items.title}}</h3>

                                <div class="blog-meta big-meta">
                                    <small><a href="marketing-single.html" title="">{{items.date}}</a></small>
                                    <small><a href="blog-author.html" title="">{{items.author}}</a></small>
                                    <small><a href="#" title=""><i class="fa fa-eye"></i> {{items.see}}</a></small>
                                </div><!-- end meta -->
